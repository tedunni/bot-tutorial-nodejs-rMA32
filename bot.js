...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/cool guy/;  botRegexTed=/^\/everyone/;botRegexDL = /^\/DDL/i;botRegexSalt = /^\/salt/;botRegexRules = /^\/rules/
  ...
  else if(request.text && botRegexhatesmiley.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://i.groupme.com/400x400.jpeg.41520f885eb049a0a5bfdba110643a0d");
    this.res.end();
  }
  else if(request.text && botRegexshovel.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://https://i.groupme.com/1156x1500.jpeg.00a751d30c254c67a24ecda8f6967725");
    this.res.end();
  }
